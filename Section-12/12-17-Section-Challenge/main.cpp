...
int *apply_all(const int *const arr1, const size_t size1, const int *const arr2,
               const size_t size2);
...
int *apply_all(const int *const arr1, const size_t size1, const int *const arr2,
    ...
    for (size_t arr2_index{0}; arr2_index < size2; arr2_index++) {
        for (size_t arr1_index{0}; arr1_index < size1; arr1_index++) {
            new_arr[new_arr_index] = arr1[arr1_index] * arr2[arr2_index];
            new_arr_index++;
        }
    }
